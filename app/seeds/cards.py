...
def seed_cards():
    card1_deck1 = Card(
            deck_id=1, question = "What type of landform protrudes from a larger landmass, and is surrounded by water on three sides?", answer="PENINSULA: Well-known peninsulas include the Arabian Peninsula, Alaska, and Cape Cod, Massachusetts.",
            mastery=1
    )
    card2_deck1 = Card(
            deck_id=1, question = "Lines of latitude run _______ to the equator while lines of longitude run _______ to the equator.", answer="parallel, perpendicular: Both latitude and longitude are measured in degrees, minutes, and seconds. For example: New York City is situated at 40.7128° N latitude, 74.0060° W longitude. GPS systems use such precise measurements to help orient navigation and weather equipment.",
            mastery=2
    )
    card3_deck1 = Card(
            deck_id=1, question = "How long did the French Revolution last?", answer="roughly 10 years (1789-1799): The French Revolution marked the end of the Ancien Régime, the absolute monarchy that had lasted for centuries. It facilitated several important philosophies such as the Declaration of the Rights of Man and of the Citizen. ",
            mastery=3
    )
    card4_deck1 = Card(
            deck_id=1, question = "What landmark became the tallest man-made structure in 2010?", answer="Burj Khalifa: The Burj Khalifa is 2,722 feet (829 m) tall and is located in Dubai, United Arab Emirates. ",
            mastery=4
    )
    card5_deck1 = Card(
    ...
    card8_deck1 = Card(
            ...
            Some studies show that nearly 5-10 percent of the population suffers from varying degrees of dyslexia. """,
            mastery=3
    )
    card9_deck1 = Card(
    ...
    card1_deck2 = Card(
            deck_id=2, question = "What part of the inner brain resembles a seahorse and is responsible for regulating learning & memory?", answer="hippocampus",
            mastery=1
    )
    card2_deck2 = Card(
    ...
    card3_deck2 = Card(
            deck_id=2, question = "______________ science is the study of the mind & intelligence, while ______________ science is the study of the anatomy & physiology of the brain.", answer="Cognitive science / neuroscience",
            mastery=1
    )
    card4_deck2 = Card(
    ...
    card6_deck2 = Card(
            deck_id=2, question = """Which 19th and 20th-century scientist is recognized as the Father of Psychoanalysis and is particularly famous for his analyses of dreams and the subconscious?""", answer="Sigmund Freud (1856 - 1939)",
            mastery=1
    )
    card7_deck2 = Card(
    ...
    card8_deck2 = Card(
            deck_id=2, question = "What is the name of the inhibitory neurotransmitter involved in the regulation of mood, sleep, appetite, and memory?", answer="serotonin: Serotonin is derived from the amino acid tryptophan.",
            mastery=1
    )
    card9_deck2 = Card(
    ...
    card1_deck3 = Card(
            deck_id=3, question = "Name the capital of: Australia", answer="Canberra",
            mastery=5
    )
    card2_deck3 = Card(
            deck_id=3, question = "Name the capital of: Egypt", answer="Cairo",
            mastery=5
    )
    card3_deck3 = Card(
            deck_id=3, question = "Name the capital of: Argentina", answer="Buenos Aires",
            mastery=5
    )
    card4_deck3 = Card(
            deck_id=3, question = "Name the capital of: Chile", answer="Santiago",
            mastery=5
    )
    card5_deck3 = Card(
            deck_id=3, question = "Name the capital of: Japan", answer="Tokyo",
            mastery=5
    )
    card6_deck3 = Card(
            deck_id=3, question = "Name the capital of: Malaysia", answer="Kuala Lumpur",
            mastery=5
    )
    card7_deck3 = Card(
            deck_id=3, question = "Name the capital of: Thailand", answer="Bangkok",
            mastery=5
    )
    card8_deck3 = Card(
            deck_id=3, question = "Name the capital of: Austria", answer="Vienna",
            mastery=5
    )
    card9_deck3 = Card(
            deck_id=3, question = "Name the capital of: Brazil", answer="Brasilia",
            mastery=5
    )
    card10_deck3 = Card(
            deck_id=3, question = "Name the capital of: Pakistan", answer="Islamabad",
            mastery=5
    )
    card11_deck3 = Card(
            deck_id=3, question = "Name the capital of: Pakistan", answer="Islamabad",
    ...
    card6_deck4 = Card(
            deck_id=4, question = """Which English rock band of the 1970s and 80s produced songs such as Bohemian Rhapsody, We Are the Champions, We Will Rock You, and Another One Bites the Dust?""", answer="""Queen: Queen was best known for their originality and their showmanship. They were voted the greatest British band of all time in a national BBC poll.""",
            mastery=1
    )
    card7_deck4 = Card(
    ...
    card9_deck4 = Card(
            deck_id=4, question = """Which type of wine requires the grape skins to be removed before fermentation?""", answer="""white wine: While red wine ferments with the grape skins and juice combined in a tank or vat, white wines are pressed before fermentation, separating the juice from the skins.""",
            mastery=0
    )
    card10_deck4 = Card(
            deck_id=4, question = """What does this social media acronym mean? ICYMI""", answer="""in case you missed it""",
            mastery=0
    )
    card11_deck4 = Card(
            deck_id=4, question = """What does this social media acronym mean? ICYMI""", answer="""in case you missed it""",
    ...
    card1_deck5 = Card(
            deck_id=5, question = """When you have a brother who only has one biological parent in common with you, he is your ____-brother.""", answer="""half-brother: For example, if your father had kids from a previous marriage, those kids would be your half-siblings.""",
            mastery=5
    )
    card2_deck5 = Card(
            deck_id=5, question = """The ______, also called The Academy Awards, is an award ceremony which recognizes artistic and technical merit in the film industry.""", answer="""Oscars: The Oscars are seen by many as the most prestigious award one can win in the entertainment industry.""",
            mastery=5
    )
    card3_deck5 = Card(
            deck_id=5, question = """What award ceremony recognizes outstanding achievement in the music industry of the USA?""", answer="""The Grammy Awards: The event is held annually, and the award is a trophy depicting a gilded gramophone.""",
            mastery=5
    )
    card4_deck5 = Card(
            deck_id=5, question = """The children of your stepmother are your ____________.""", answer="""stepsiblings (stepbrothers and stepsisters): Note that stepsiblings share no biological parents (even if one of each of their parents have married each other), while half-siblings share one biological parent.""",
            mastery=5
    )
    card5_deck5 = Card(
            deck_id=5, question = """True or false:

            If you think a victim lying on the ground may have injured their spine, you should immediately move them to a bed or soft surface to prevent further damage.""", answer="""FALSE: Important: never move a victim from their location unless their current position provides an immediate risk to their life. If the victim's neck or spinal column is broken, then moving them may lacerate their spinal cord and lead to permanent paralyzation. Stop traffic if you have to!""",
            mastery=5
    )
    card6_deck5 = Card(
            deck_id=5, question = """What single appliance uses the most electricity in a household?""", answer="""refrigerator: Studies show the refrigerator to use up about 30 percent of the electricity in your home.""",
            mastery=5
    )
    card7_deck5 = Card(
    ...
    card9_deck5 = Card(
            deck_id=5, question = """What small, seed-like grain is popular today with vegans and vegetarians, and is commonly used in cold salads or as a hot side dish?""", answer="""quinoa (keen-waa)""",
            mastery=0
    )
    card10_deck5 = Card(
            deck_id=5, question = """Which American actor famously won an Oscar for co-writing the screenplay for Good Will Hunting, in which he also starred?""", answer="""Matt Damon""",
            mastery=0
    )

    card1_deck6 = Card(
            deck_id=6, question = """The sun rises in the ____ and sets in the ____.""", answer="""east, west: Knowing the directions east and west, one can determine where north and south is without a compass.""",
            mastery=0
    )
    card2_deck6 = Card(
    ...
    card3_deck6 = Card(
            deck_id=6, question = """You can tie a ____ ____ around a leafy branch to collect water from vegetation over time.""", answer="""plastic bag: Plants “sweat”, just like humans. By tying a plastic bag around a leafy branch you can collect the moisture they produce through respiration, especially if you are lost for many days.""",
            mastery=0
    )
    card4_deck6 = Card(
            deck_id=6, question = """A safe way to kill off any pathogens (“germs”) in water is to ____ the water.""", answer="""boil: All you need is a few minutes. Boiling can be helpful if you ever need to use rainwater or snow as a source of drinking water during a shortage.""",
            mastery=0
    )
    card5_deck6 = Card(
    ...
    card7_deck6 = Card(
            ...
            Meanwhile, as long as the body as hydrated, a person can survive without food for up to a month or even longer.""",
            mastery=3
    )
    card8_deck6 = Card(
    ...
    card9_deck6 = Card(
            deck_id=6, question = """If you encounter a wolf in the wild what should you do?""", answer="""Do not turn your back, look the wolf in the eye and slowly back away""",
            mastery=3
    )
    card10_deck6 = Card(
            deck_id=6, question = """What can you coat matches with to make them waterproof?""", answer="""nailpolish""",
            mastery=3
    )
    card11_deck6 = Card(
            deck_id=6, question = """What can you coat matches with to make them waterproof?""", answer="""nailpolish""",
    ...
    card4_deck7 = Card(
            deck_id=7, question = """supplant (suh-plant)""", answer="""v. to replace: The higher-ups tried to supplant rebellious teachers with conformists.""",
            mastery=3
    )
    card5_deck7 = Card(
            deck_id=7, question = """supplicate: (sup-lih-kate)""", answer="""v. to humbly ask: The churchgoers then bowed their heads and supplicated God to answer their prayers.""",
            mastery=3
    )
    card6_deck7 = Card(
            deck_id=7, question = """surreptitious (ser-up-tish-us)""", answer="""adj. secretive (especially because it would not be approved of): Since they were not allowed to speak, the couple exchanged surreptitious glances from across the room.""",
            mastery=3
    )
    card7_deck7 = Card(
            deck_id=7, question = """surmount (ser-mount)""", answer="""v. to overcome
            v. to rise above: Through sheer determination, he was able to surmount his disadvantages and win the contest outright.""",
            mastery=0
    )
    card8_deck7 = Card(
            deck_id=7, question = """supersede

            (sue-per-seed)""", answer="""v. to substitute; to take precedence over: It had been my understanding that the new tax code supersedes the old one, but actually both are in vigor simultaneously.""",
            mastery=0
    )
    card9_deck7 = Card(
            deck_id=7, question = """opportune (opp-er-tune)""", answer="""adj. happening under fitting circumstances: The students waited for an opportune moment to surprise their teacher with the bouquet of flowers they had prepared.""",
            mastery=0
    )
    card10_deck7 = Card(
    ...
    cards = [card1_deck1, card2_deck1, card3_deck1, card4_deck1, card5_deck1, card6_deck1, card7_deck1, card8_deck1, card9_deck1, card10_deck1,
             card1_deck2, card2_deck2, card3_deck2, card4_deck2, card5_deck2, card6_deck2, card7_deck2, card8_deck2, card9_deck2, card10_deck2, card11_deck2,
             card1_deck3, card2_deck3, card3_deck3, card4_deck3, card5_deck3, card6_deck3, card7_deck3, card8_deck3, card9_deck3, card10_deck3, card11_deck3, card12_deck3, card13_deck3,
             card1_deck4, card2_deck4, card3_deck4, card4_deck4, card5_deck4, card6_deck4, card7_deck4, card8_deck4, card9_deck4, card10_deck4, card11_deck4,
             card1_deck5, card2_deck5, card3_deck5, card4_deck5, card5_deck5, card6_deck5, card7_deck5, card8_deck5, card9_deck5, card10_deck5,
             card1_deck6, card2_deck6, card3_deck6, card4_deck6, card5_deck6, card6_deck6, card7_deck6, card8_deck6, card9_deck6, card10_deck6, card11_deck6, card12_deck6,
